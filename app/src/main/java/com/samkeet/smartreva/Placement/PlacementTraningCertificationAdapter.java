...
public class PlacementTraningCertificationAdapter extends RecyclerView.Adapter<PlacementTraningCertificationAdapter.ViewHolder> {
    ...
    public PlacementTraningCertificationAdapter(String[] mTitle, String[] mDuration, String[] mFP, String[] mEP, String[] mOrg, String[] mSubject) {
        this.mTitle = mTitle;
    ...
    @Override
    public PlacementTraningCertificationAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
