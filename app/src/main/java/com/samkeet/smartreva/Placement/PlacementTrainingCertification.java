...
public class PlacementTrainingCertification extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_placement_training_certification);
    ...
    public void AddTandC(View v){
        Intent intent=new Intent(getApplicationContext(),PlacementNewTraningCertification.class);
    ...
    public class GetTandC extends AsyncTask<Void, Void, Integer> {
        ...
        protected void onPostExecute(Integer result) {
            ...
            if (authenticationError) {
                ...
                mAdapter = new PlacementTraningCertificationAdapter(mTitle, mDuration, mFP,mEP, mOrg,mSubject);
