...
public class MentorPlacementMainActivity extends AppCompatActivity {
    ...
    public void PendingApproval(View v) {
        Intent intent = new Intent(getApplicationContext(), MentorPlacementPendingApprovalActivity.class);
        startActivity(intent);
    }
