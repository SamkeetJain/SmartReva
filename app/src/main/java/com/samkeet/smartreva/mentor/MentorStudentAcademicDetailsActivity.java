...
public class MentorStudentAcademicDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mentor_student_academic_details);
        ...
        mRecyclerView.addOnItemTouchListener(new RecyclerView.OnItemTouchListener() {
            ...
            public boolean onInterceptTouchEvent(RecyclerView rv, MotionEvent motionEvent) {
                ...
                if (child != null && mGestureDetector.onTouchEvent(motionEvent)) {
                    ...
                    Intent intent = new Intent(getApplicationContext(), MentorStudentAcademicDetailsManager.class);
