 ...
 */
public class MentorStudentListAdapter extends RecyclerView.Adapter<MentorStudentListAdapter.ViewHolder> {
    ...
    public MentorStudentListAdapter(String[] mSrn, String[] mName) {
        this.mName = mName;
        this.mSrn =mSrn;
    ...
    @Override
    public MentorStudentListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
