...
public class EventsMainActivityAdapter extends RecyclerView.Adapter<EventsMainActivityAdapter.ViewHolder> {
    ...
    public EventsMainActivityAdapter(String[] mType, String[] mDesc, String[] mDates, String[] mNames) {
        this.mType = mType;
        this.mDesc = mDesc;
        this.mDates = mDates;
        this.mNames = mNames;
    ...
    @Override
    public EventsMainActivityAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
