...
public class PlacementRegistration1 extends AppCompatActivity {
    ...
    public EditText mSrn, mPassword, mCPassword, mFullname, mDob, mPhone, mEmail, mCurrentAddress, mPermanentAddress;
    public TextInputLayout tSrn, tPassword, tCPassword, tFullname, tDob, tPhone, tEmail, tCurrentAddress, tPermanentAddress;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDob = (EditText) findViewById(R.id.dob_et);
        ...
        tDob = (TextInputLayout) findViewById(R.id.tDOB);
    ...
    private boolean validPassword() {
        ...
        if (password.length() > 10) {
            tPassword.setError("Password Should be less than 10 characters");
            requestFocus(mPassword);
            return false;
        } else {
