...
public class AttendenceTakeAttendence extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attendence_take_attendence);
    ...
    private class GetStudentsList extends AsyncTask<Void, Void, Integer> {
        ...
        protected void onPostExecute(Integer result) {
            ...
            if (authenticationError) {
                ...
                mAdapter = new AttendenceTakeAttendenceAdapter(studentsList,studentsName);
    ...
    public void Submit(View v) {
        ...
        boolean check[] = ((AttendenceTakeAttendenceAdapter) mAdapter).getCheckBoxes();
        ...
        String[] fields = ((AttendenceTakeAttendenceAdapter) mAdapter).getTitles();
