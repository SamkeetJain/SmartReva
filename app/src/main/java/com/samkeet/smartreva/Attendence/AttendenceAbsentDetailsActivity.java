...
public class AttendenceAbsentDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attendence_absent_details);
    ...
    private class GetAbsentDetails extends AsyncTask<Void, Void, Integer> {
        ...
        protected void onPostExecute(Integer result) {
            ...
            if (authenticationError) {
                ...
                mAdapter = new AttendenceAbsentDetailsAdapter(titles);
