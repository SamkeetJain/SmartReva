...
public class AttendenceGenerateListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attendence_generate_list);
        ...
        mAdapter = new AttendenceGenerateListAdapter(titles);
