...
public class
AttendenceAbsentDetailsAdapter extends RecyclerView.Adapter<AttendenceAbsentDetailsAdapter.ViewHolder> {
    ...
    public AttendenceAbsentDetailsAdapter(String[] mTitle) {
        this.mTitle = mTitle;
    }

    @Override
    public AttendenceAbsentDetailsAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
