...
public class AttendenceViewAttendenceAdapter extends RecyclerView.Adapter<AttendenceViewAttendenceAdapter.ViewHolder> {
    ...
    public AttendenceViewAttendenceAdapter(String[] mTitle) {
        this.mTitle = mTitle;

    }

    @Override
    public AttendenceViewAttendenceAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
