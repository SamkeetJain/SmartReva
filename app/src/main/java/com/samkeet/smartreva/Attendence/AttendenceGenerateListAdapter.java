...
public class AttendenceGenerateListAdapter extends RecyclerView.Adapter<AttendenceGenerateListAdapter.ViewHolder> {
    ...
    public AttendenceGenerateListAdapter(String[] mTitle) {
        this.mTitle = mTitle;
    }

    @Override
    public AttendenceGenerateListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
